...
const static PROGMEM char chtemp[] = "Temperature";
const static PROGMEM PGM_P const channelName[] = {ch0, ch1, ch2, chtemp};
const static PROGMEM uint8_t channels[] = {0, 1, 2, 8};
...
ISR(ADC_vect, ISR_NOBLOCK)
{
	...
	*adcBufferCurrent = ADCH;
	...
	chSeqCurrent = channelSequence;
	ADMUX = _BV(REFS0) | _BV(ADLAR) | *chSeqCurrent;
